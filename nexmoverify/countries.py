COUNTRY_CODES = (
('', '- Select -'), ('AF', 'Afghanistan'), ('AL', 'Albania'),
('DZ', 'Algeria'), ('AS', 'American Samoa'), ('AD', 'Andorra'),
('AO', 'Angola'), ('AI', 'Anguilla'), ('AQ', 'Antartica'),
('AG', 'Antigua and Barbuda'), ('AR', 'Argentina'), ('AM', 'Armenia'),
('AW', 'Aruba'), ('AC', 'Ascension Island'), ('AU', 'Australia'),
...
('DK', 'Denmark'), ('DG', 'Diego Garcia'), ('DJ', 'Djibouti'),
...
('IN', 'India'), ('ID', 'Indonesia'), ('WW', 'International'),
...
('QA', 'Qatar'), ('CG', 'Republic Of The Congo'), ('RO', 'Romania'),
('RU', 'Russia'), ('RW', 'Rwanda'), ('RE', 'Reunion Island'),
